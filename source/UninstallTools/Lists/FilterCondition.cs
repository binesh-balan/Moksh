                ...
                try
                {
                    switch (ComparisonMethod)
                    {
                        ...
                        case ComparisonMethod.Regex:
                            // Timeout: FilterText comes from .bcul list files, which users share and
                            // download, and it runs against every discovered application. A pattern
                            // that backtracks catastrophically would otherwise hang the app for good.
