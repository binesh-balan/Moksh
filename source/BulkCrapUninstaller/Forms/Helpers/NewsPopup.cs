...
namespace BulkCrapUninstaller.Forms
{
    public partial class NewsPopup : Form
    {
        ...
        public static void ShowPopup(Form owner)
        {
            ...
            // Every link on this popup is an external destination MOKSH does not configure,
            // so there is nothing left for it to show.
            if (!BrandLinks.IsSet(Resources.GithubReleasesLink)
                && !BrandLinks.IsSet(Resources.GithubLink)
                && !BrandLinks.IsSet(Resources.DonateLink)
                && !FeedbackBox.IsAvailable)
                return;
        ...
        {
            BrandLinks.Open(Resources.GithubReleasesLink);
        }
        ...
        {
            BrandLinks.Open(Resources.GithubLink);
        }
