...
namespace BulkCrapUninstaller.Forms
{
    public partial class JunkRemoveWindow : Form
    {
        ...
        private void CreateBackup(string backupPath)
        {
            ...
            catch (Exception ex)
            {
                ...
                if (ex is FileNotFoundException)
                    ex = new UnauthorizedAccessException("You do not have access to this path, choose a different path. If you use controlled folders, try turning them off or adding MØKSH to exclusions.", ex);
        ...
        {
            return "MOKSH Backup " + DateTime.Now.ToString(BackupDateFormat, CultureInfo.InvariantCulture);
        }
