...
namespace BulkCrapUninstaller.Forms
{
    public partial class FirstStartBox : Form
    {
        ...
        public FirstStartBox(bool canExit)
        {
            ...
            // MOKSH has no contact form or homepage. Hide each link together with the
            // sentence that introduces it - a lone "If you are willing to help translate..."
            // with no link below it reads as a broken page.
            BrandLinks.HideUnless(Resources.ContactUrl,
                p1languageExtradetails, p1linkLabelContact,
                p5finishContact, p5LinkContact);

            BrandLinks.HideUnless(Resources.HomepageUrl,
                p5finishHomepage, p5LinkHomepage);
        ...
        {
            BrandLinks.Open(Resources.ContactUrl);
        }

        private void OpenHomepage(object sender, LinkLabelLinkClickedEventArgs e)
        {
            BrandLinks.Open(Resources.HomepageUrl);
        }
