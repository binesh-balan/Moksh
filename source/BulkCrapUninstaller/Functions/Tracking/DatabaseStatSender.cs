...
namespace BulkCrapUninstaller.Functions.Tracking
{
    public class DatabaseStatSender
    {
        ...
        {
            // MOKSH ships without a telemetry backend. Statistics are still gathered locally into
            // UsageStatistics.xml (and can be inspected or deleted by the user) but are never uploaded.
