...
uk.InstallPortableTitle =Портативне встановлення
...
uk.InstallTypeChoiceTitle =Тип встановлення
...
uk.InstallStandardTitle =Стандартне встановлення
...
uk.InstallPortableInfo =Портативне встановлення не реєструє себе в системі, воно лише розпаковує файли у вказану теку. Ви можете вказати будь-яку теку, наприклад, на USB-накопичувачі. Ви зможете вільно переміщувати цю теку, оскільки весь застосунок знаходиться всередині неї.
...
InstallStandardInfo =This option will install MØKSH on your computer as a normal application. Standard uninstaller will be created and it will be visible under "Programs and Features" as well as in other third-party uninstallers.
...
de.InstallStandardInfo =Diese Option installiert MØKSH auf Ihrem Computer als normale Anwendung. Ein normales Deinstallationsprogramm wird erstellt, und der Eintrag wird unter "Programme und Features" ebenso wie in anderen Drittanbieter-Uninstallern angezeigt.
fr.InstallStandardInfo =Cette option installera MØKSH sur votre ordinateur comme une application normale. Un désinstalleur standard sera créé et sera visible sous "Programmes et Fonctionnalités" aussi bien que pour tout autre désinstalleur tiers.
hu.InstallStandardInfo =Ezzel a lehetõséggel úgy kerül telepítésre a MØKSH, mint egy normál alkalmazás. A szabványos eltávolítója megtalálható lesz a "Programok és szolgáltatások" ablakban, valamint az egyéb eltávolítókban.
sl.InstallStandardInfo =Ta možnost bo MØKSH namestila v racunalnik kot obicajno aplikacijo. Ustvarjen bo standardni odstranjevalec, ki bo viden v razdelku  "Programi in funkcije", kot tudi v drugih odstranjevalcih  tretjih avtorjev.
...
es.InstallStandardInfo =Esta opción instalará MØKSH en su equipo como una aplicación normal. Se creará un desinstalador estándar y estará visible en "Programas y características", así como otros desinstaladores de terceros.
bpt.InstallStandardInfo =Esta opção irá instalar o MØKSH em seu computador como um aplicativo normal. O desinstalador padrão será criado e estará visível em "Programas e recursos", bem como em outros desinstaladores de terceiros.
ru.InstallStandardInfo =Эта опция установит MØKSH на ваш компьютер как обычное приложение. Будет создана стандартная программа удаления, которая будет видна в разделе «Программы и компоненты», а также в других сторонних программах удаления.
it.InstallStandardInfo =Questa opzione abiliterà l'installazione di MØKSH nel computer come una normale applicazione. Verrà creato il programma di disinstallazione standard e sarà visibile in "Programmi e funzionalità" così come in altri programmi di disinstallazione di terze parti.
uk.InstallStandardInfo =Цей варіант встановить MØKSH на ваш комп'ютер як звичайний застосунок. Буде створено стандартний засіб видалення, який відображатиметься в розділі "Програми та компоненти", а також в інших сторонніх засобах видалення.
tr.InstallStandardInfo =Bu seçenek MØKSH'ı bilgisayarınıza normal bir yazılım olarak yükleyecektir. Standart kaldırıcı oluşturulacak ve diğer üçüncü taraf kaldırıcıların yanı sıra “Program ekle ve kaldır” altında da görülebilecektir.
zh_cn.InstallStandardInfo =此选项会将 MØKSH 作为普通应用程序安装到电脑上。标准卸载程序将被创建，并在 “程序和功能 ”以及其他第三方卸载程序中可见。
hi.InstallStandardInfo=यह विकल्प MØKSH को आपके कंप्यूटर पर सामान्य ऐप्लिकेशन के रूप में इंस्टॉल करेगा। एक मानक अनइंस्टॉलर बनाया जाएगा और यह 'प्रोग्राम्स और फीचर्स' के अंतर्गत तथा अन्य थर्ड-पार्टी अनइंस्टॉलर में दिखाई देगा.
